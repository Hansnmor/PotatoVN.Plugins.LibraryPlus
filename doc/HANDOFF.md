...
> 当前版本：v1.4.1。仓库：https://github.com/Hansnmor/PotatoVN.Plugins.LibraryPlus （分支 main）
...
5. **版本号**：改 `PotatoVN.App.PluginBase.csproj` 的 `<Version>`（当前 1.4.1），与 GitHub tag 对齐。
